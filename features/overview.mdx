...
<Note>
  **New to CodinIT?** Visit our [Quickstart Guide](/quickstart) to get up and running in minutes, or explore our [Providers Guide](/providers/guide) to learn about integrating with 19+ AI providers.
</Note>