...
<AccordionGroup>
  <Accordion icon="cpu" title="What are the best models for CodinIT.dev?">
  ...
  <Accordion icon="key" title="How do I configure API keys for different providers?">
    ...
    **Option 2: In-App Configuration**
    ...
    <Note>Never commit API keys to version control. The `.env.local` file is already in `.gitignore`.</Note>
  </Accordion>

  <Accordion icon="plug" title="How do I add a new LLM provider?">
  ...
  <Accordion icon="star" title="How do I set up Moonshot AI (Kimi) provider?">
  ...
  <Accordion icon="zap" title="What are the latest xAI Grok models?">
...
<AccordionGroup>
  <Accordion icon="question-circle" title="How do I access help and documentation?">
  ...
  <Accordion icon="sparkles" title="How do I get the best results with CodinIT.dev?">
  ...
  <Accordion icon="puzzle-piece" title="How do I use MCP (Model Context Protocol) tools?">
  ...
  <Accordion icon="rocket" title="How do I deploy my CodinIT.dev projects?">
  ...
  <Accordion icon="git-branch" title="How do I use Git integration features?">
...
<AccordionGroup>
  <Accordion icon="users" title="How do I contribute to CodinIT.dev?">
    Check out our GitHub repository for contribution guidelines and get involved with the community!
  </Accordion>

  <Accordion icon="road" title="What are the future plans for CodinIT.dev?">
    Visit our [Roadmap](https://roadmap.sh/r/ottodev-roadmap-2ovzo) for the latest updates.
    New features and improvements are on the way!
  </Accordion>

  <Accordion icon="comments" title="Why are there so many open issues/pull requests?">
...
<AccordionGroup>
  <Accordion icon="newspaper" title="What's new in CodinIT.dev?">
  ...
  <Accordion icon="template" title="How do I use the new project templates?">
  ...
  <Accordion icon="container" title="How does WebContainer work?">
  ...
  <Accordion icon="database" title="How do I connect external databases?">
...
<AccordionGroup>
  <Accordion icon="scale" title="How do local LLMs compare to larger models like Claude 3.5 Sonnet for CodinIT.dev?">
...
<AccordionGroup>
  <Accordion icon="exclamation-triangle" title="There was an error processing this request">
  ...
  <Accordion icon="key" title="x-api-key header missing">
  ...
  <Accordion icon="eye-slash" title="Blank preview when running the app">
  ...
  <Accordion icon="unplug" title="MCP server connection failed">
  ...
  <Accordion icon="git-branch" title="Git integration not working">
  ...
  <Accordion icon="rocket" title="Deployment failed">
  ...
  <Accordion icon="thumbs-down" title="Everything works, but the results are bad">
  ...
  <Accordion icon="display" title="WebContainer preview not loading">
  ...
  <Accordion icon="/assets/frameworks/icons/windows.svg" title="Received structured exception #0xc0000005: access violation">
  ...
  <Accordion icon="laptop" title="Miniflare or Wrangler errors in Windows">
  ...
  <Accordion icon="plug" title="Provider not showing up after adding it">
