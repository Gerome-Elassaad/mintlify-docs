...
<CardGroup cols={1}>
  <Card title="Use On The Web" icon="user-plus" href="https://codingit.vercel.app">
    Sign up for a **free CodinIT account** to get:
...
<Tabs>
  <Tab title="Local Version" icon="code">
    <Frame>
      <img
      	src="https://storage.googleapis.com/codinit_public_images/vscode.png"
      	alt="VS Code logo"
    ...
    <Steps>
      ...
      <Step title="Search for Codinit">
        Type **"Codinit"** in the Extensions marketplace search bar
        	<Frame>
            <img src="https://storage.googleapis.com/codinit_public_images/extension-installation.png" alt="VS Code marketplace showing Codinit extension" 
            />
          </Frame>
      </Step>

      <Step title="Install">
        Click the **Install** button on the Codinit extension
        
        <Frame caption="VS Code marketplace with Codinit extension ready to install">
        	<img
        		src="https://storage.googleapis.com/codinit_public_images/docs/assets/image%20(20).png"
        		alt="VS Code marketplace showing Codinit extension"
        	/>
        </Frame>
      </Step>

      <Step title="Access Codinit">
        After installation completes:
        - Click the **Codinit icon** in the Activity Bar, or
        - Open Command Palette (`Ctrl/Cmd + Shift + P`) → type **"Codinit: Open In New Tab"**

        <Frame caption="Codinit opened in VSCode">
        	<img
        		src="https://storage.googleapis.com/codinit_public_images/after-installation.png"
        		alt="Codinit opened in VSCode"
        	/>
        </Frame>
        
        <Warning>
        If VS Code shows "Running extensions might..." dialog, click **Allow**. If you don't see the Codinit icon, restart VS Code.
        </Warning>
      </Step>
    </Steps>

    <Check>
    **Installation Complete!** You should now see the Codinit interface in your editor. Time to sign in!
    </Check>
  ...
  <Tab title="JetBrains IDEs" icon="brain">
    <img
    	src="https://storage.googleapis.com/codinit_public_images/docs/assets/jetbrains-logo.svg"
    	alt="JetBrains logo"
    	style={{ width: "200px", height: "auto", margin: "0 auto 20px auto", display: "block" }}
    />

    <Note>
    Codinit for JetBrains works almost identically to VS Code, with all core features: diff editing, tools, multiple API providers, MCP servers, Codinit rules/workflows, and more.
    </Note>
      ...
      <Tab title="Web Version">
        <Steps>
          <Step title="Open Settings">
            In your VS Code IDE, go to **Settings**:
            - Windows/Linux: `Ctrl+Alt+S`
            - macOS: `Cmd+,`
          </Step>

          <Step title="Navigate to Plugins">
            Go to **Terminal** → **Paste** below
          </Step>

          <Step title="Install CodinIT">
            Connect your GitHub **"Then Clone The Repo"** by opening your **terminal**
            
            <Frame>
            	<img
            		src="https://storage.googleapis.com/codinit_public_images/jetbrains-installation.png"
            		alt="marketplace showing Codinit plugin search results"
            	/>
            </Frame>
          </Step>
          ...
          <Step title="Restart IDE">
            ...
            <Frame>
            	<img
            		src="https://storage.googleapis.com/codinit_public_images/jetbrains-post-installation.png"
            		alt="marketplace showing Codinit plugin search results"
            	/>
            </Frame>
          </Step>
      ...
      <Tab title="Browser Install">
        <Steps>
          <Step title="Visit Marketplace">
            Go to the [JetBrains Marketplace](https://plugins.jetbrains.com/plugin/28247-codinit)
          </Step>
      ...
      <Tab title="Manual Install">
        <Steps>
          <Step title="Download Plugin">
            Download from the [marketplace page](https://plugins.jetbrains.com/plugin/28247-codinit)
          </Step>
    ...
    <Check>
    **Installation Complete!** Find Codinit in **View** → **Tool Windows** → **Codinit** (usually on the right side).
    </Check>
