...
The Model Context Protocol (MCP) enables AI models to interact with external tools, data sources, and APIs, significantly expanding their capabilities beyond simple text generation. CodinIT provides comprehensive MCP integration with support for multiple server types and advanced tool management.
...
<CardGroup cols={3}>
  ...
  <Card title="System Integration" icon="cpu">
...
<ParamField name="args" type="array">
...
<ParamField name="env" type="object">
...
<CardGroup cols={2}>
  ...
  <Card title="Event Streaming" icon="activity">
