...
<CardGroup cols={2}>
  ...
  <Card title="Hugging Face" icon="/assets/ai-icons/huggingface.svg" href="/providers/hugging-face">
    Your favourite Hugging Face models available
  </Card>
...
<CardGroup cols={2}>
  ...
  <Card title="Run Models Locally" icon="server" href="/running-models-locally/guide">
