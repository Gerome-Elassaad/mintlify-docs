...
<AccordionGroup>
  <Accordion icon="download" title="Install CodinIT">
    ...
    **Desktop App Version (Recommended)**
    - Download from [codinit.com/download](https://codinit.com/download)
...
<Card title="AI Provider Guide" icon="plug" href="/providers/1.overview">
...
<Card title="Settings" icon="cog" href="/essentials/settings">
